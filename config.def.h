...
static const char *menucmd[] = { "sh", "-c", "env BEMENU_OPTS='" BEMENU_OPTS "' bemenu-run", NULL };
static const char *dmenucmd[] = { "sh", "-c", "env BEMENU_OPTS='" BEMENU_OPTS "' bemenu-run", NULL };
static const char *yazicmd[] = { "foot", "--app-id", "yazi", "-e", "yazi", NULL };
static const char *pulsemixercmd[] = { "foot", "--app-id", "pulsemixer", "-e", "pulsemixer", NULL };
static const char *hyprpickercmd[] = { "hyprpicker", "-a", NULL };
static const char *screentoggle_cmd[] = { "wlr-randr", "--output", "DP-1", "--toggle", NULL };
...
static const Key keys[] = {
	...
	{ WLR_MODIFIER_CTRL, XKB_KEY_Escape, spawn, { .v = screentoggle_cmd } },
	{ MODKEY, XKB_KEY_period, spawn,
		SHCMD("env BEMENU_OPTS='" BEMENU_OPTS "' bash ~/.local/bin/scripts/emoji-picker.sh") },
	{ MODKEY, XKB_KEY_w, spawn,
		SHCMD("env BEMENU_OPTS='" BEMENU_OPTS "' bash ~/.local/bin/scripts/wallpaper-picker.sh") },
	{ MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_s, spawn,
		SHCMD("grim -g \"$(slurp)\" - | tee ~/Pictures/Screenshots/screenshot_$(date +%Y%m%d_%H%M%S).png | wl-copy") },
	...
	/* session */
	{ WLR_MODIFIER_CTRL | WLR_MODIFIER_ALT, XKB_KEY_Escape, quit, { 0 } },
